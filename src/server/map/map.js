        ...
        for (let currentPlayer of this.players.data) {
            ...
            const extractData = (player) => {
                return {
                    ...
                    darkMatter: player.darkMatter || 0,
                    sabotageCooldownUntil: player.sabotageCooldownUntil || 0,
                    warpCooldownUntil: player.warpCooldownUntil || 0,
                    warpBoostUntil: player.warpBoostUntil || 0,
                    target: player.target || { x: 0, y: 0 }
                };
            }
